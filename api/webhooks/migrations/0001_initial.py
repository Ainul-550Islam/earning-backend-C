    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(help_text='Human-readable name for this endpoint.', max_length=120, verbose_name='Label')),
                ('target_url', models.URLField(help_text='The HTTPS endpoint that will receive dispatched payloads.', max_length=2048, validators=[django.core.validators.URLValidator(schemes=['https', 'http'])], verbose_name='Target URL')),
                ('http_method', models.CharField(choices=[('POST', 'POST'), ('PUT', 'PUT'), ('PATCH', 'PATCH')], default='POST', max_length=8, verbose_name='HTTP Method')),
                ('secret_key', models.CharField(default=api.webhooks.models._generate_secret_key, editable=False, help_text='HMAC-SHA256 secret auto-generated per endpoint. Sent as X-Webhook-Signature on every dispatch.', max_length=128, verbose_name='Signing Secret')),
                ...
                ('custom_headers', models.JSONField(blank=True, default=api.webhooks.models._empty_dict, help_text='Additional HTTP headers injected into every dispatch request.', verbose_name='Custom Headers')),
                ...
                ('tenant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='webhook_endpoints', to='tenants.tenant', verbose_name='Tenant')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_id', models.UUIDField(default=uuid.uuid4, editable=False, help_text='Unique ID sent as X-Webhook-Delivery-ID header.', unique=True, verbose_name='Delivery ID')),
                ...
                ('response_body', models.TextField(blank=True, default='', help_text='First 4096 chars of the response body.', verbose_name='Response Body')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filters', models.JSONField(blank=True, default=api.webhooks.models._empty_dict, help_text='Optional key-value pairs to filter dispatches. Example: {"currency": "BDT", "amount_gte": 100}', verbose_name='Payload Filters')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['owner', 'status'], name='webhooks_we_owner_i_017843_idx'),
        ),
        migrations.AddIndex(
            model_name='webhookendpoint',
            index=models.Index(fields=['tenant', 'status'], name='webhooks_we_tenant__8ad610_idx'),
        ),
        migrations.AddIndex(
            model_name='webhookdeliverylog',
            index=models.Index(fields=['endpoint', 'status'], name='webhooks_we_endpoin_692e83_idx'),
        ),
        migrations.AddIndex(
            model_name='webhookdeliverylog',
            index=models.Index(fields=['event_type', 'status'], name='webhooks_we_event_t_8503e6_idx'),
        ),
        migrations.AddIndex(
            model_name='webhookdeliverylog',
            index=models.Index(fields=['status', 'next_retry_at'], name='webhooks_we_status_c13112_idx'),
        ),
        migrations.AddIndex(
            model_name='webhookdeliverylog',
            index=models.Index(fields=['delivery_id'], name='webhooks_we_deliver_1bc221_idx'),
        ),
        migrations.AddIndex(
            model_name='webhooksubscription',
            index=models.Index(fields=['event_type', 'is_active'], name='webhooks_we_event_t_0aba44_idx'),
        ),
