...
class WebhookEndpoint(TimeStampedModel):
    ...
    class Meta:
        app_label = 'webhooks_legacy'
        verbose_name        = _("Webhook Endpoint")
        verbose_name_plural = _("Webhook Endpoints")
        ordering            = ["-created_at"]
        indexes = [
            models.Index(fields=["owner", "status"], name='idx_owner_status_1898'),
            models.Index(fields=["tenant", "status"], name='idx_tenant_status_1899'),
        ]
...
class WebhookSubscription(TimeStampedModel):
    ...
    class Meta:
        ...
        ordering            = ["event_type"]
        indexes = [
            models.Index(fields=["event_type", "is_active"], name='idx_event_type_is_active_1900'),
        ]
...
class WebhookDeliveryLog(TimeStampedModel):
    ...
    class Meta:
        ...
        ordering            = ["-created_at"]
        indexes = [
            models.Index(fields=["endpoint", "status"], name='idx_endpoint_status_1901'),
            models.Index(fields=["event_type", "status"], name='idx_event_type_status_1902'),
            models.Index(fields=["status", "next_retry_at"], name='idx_status_next_retry_at_1903'),
            models.Index(fields=["delivery_id"], name='idx_delivery_id_1904'),
        ]
