...
class AutoBlockRuleSerializer(serializers.ModelSerializer):
    """
    AutoBlockRule Serializer — only valid model fields
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            'action_type', 'action_duration_hours',
            'apply_to_all_users', 'user_groups',
            'is_active', 'priority',
            'created_at', 'updated_at',
            # Computed fields
    ...
    def get_rule_effectiveness(self, obj):
        try:
            return {'status': 'active' if obj.is_active else 'inactive'}
        except Exception:
            return {}

    def get_last_triggered_formatted(self, obj):
        try:
            val = getattr(obj, 'last_triggered', None)
    ...
    def get_trigger_count_today(self, obj):
        try:
            return getattr(obj, 'trigger_count', 0)
        except Exception:
            return 0
