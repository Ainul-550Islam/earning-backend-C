...
class OfferWallViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=True, methods=['get'], url_path='offers', url_name='wall-offers-slug')
    def get_offers_by_slug(self, request, pk=None):
        """Alias — same as get_offers but accessible via slug"""
        return self.get_offers(request, pk=pk)